<div style="position:fixed;bottom:0;left:0;right:0;z-index:50;border-top:1px solid rgba(255,255,255,.04);background:rgba(5,8,16,.85);backdrop-filter:blur(12px)">
    <div style="max-width:1320px;margin:0 auto;padding:18px 32px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px">
        <div style="display:flex;align-items:center;gap:10px">
            ...
            <div>
                <div style="font-size:.72rem;font-weight:700;color:rgba(255,255,255,.5);letter-spacing:-.01em;font-family:var(--sans)">FloppyOps Lite <span style="font-size:.58rem;font-weight:400;color:rgba(255,255,255,.25);font-family:var(--mono)">v1.0.3</span></div>
                <div style="font-size:.58rem;color:rgba(255,255,255,.25);font-family:var(--mono)">&copy; <?= date('Y') ?> Florian Hesse</div>
            </div>
        </div>
